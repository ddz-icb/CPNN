...
export const circleForceDescription = (
  <div>
    <p className="margin-0">
      Components/Clusters can be arranged in a circular layout, with the nodes arranged clockwise in descending order based on the number of adjacent
