...
export const nodeSearchDescription = (
  <div>
    <div className="margin-0">
      You can search graph nodes by formulating a query. Simple text queries are matched against node IDs, node labels, node types, and node attributes.
      Attribute expressions use the same syntax as attribute filters: combine groups with <PopupTextField textInside={"and"} />, allow alternatives
      inside parentheses with <PopupTextField textInside={"or"} />, quote attributes with more than one word, and use{" "}
    ...
    <div>
      For example, with node attributes such as <PopupTextField textInside={"mRNA splicing"} />,{" "}
...
export const linkSearchDescription = (
  <div>
    <div className="margin-0">
      You can search graph links by formulating a query. Simple text queries are matched against link IDs, link labels, link endpoints, link types,
      link attributes, and link weights. Attribute expressions use the same syntax as attribute filters: combine groups with{" "}
      <PopupTextField textInside={"and"} />, allow alternatives inside parentheses with <PopupTextField textInside={"or"} />, quote attributes with more
      than one word, and use <PopupTextField textInside={"not"} /> to exclude attributes. You can also group several attributes as a set, for example{" "}
    ...
    <PopupTextField textInside={">= 2"} /> <PopupTextField textInside={"not {lean, obese}"} />{" "}
    <PopupTextField textInside={'"t2d group" and lean'} /> <PopupTextField textInside={"(obese or lean) and >= 2"} />{" "}
    <PopupTextField textInside={"(obese or lean) and t2d"} />
  </div>
);
